...
{
    const char* uploadName = "local.txt";
    ...
    const char* pLocalFilePath = "./local.txt";
...
{
#ifdef PUBLIC
    char* domain = Qiniu_String_Concat2(bucketName, "http://o9o6wy2tb.bkt.clouddn.com");
#else
    char* domain = Qiniu_String_Concat2(bucketName, "http://o9mmpvxgk.bkt.clouddn.com");
#endif

    const char* downloadName = "a.txt";
...
#else
    mac.accessKey = "Hw_2_emX0FV5fe26brBCemk3Yhdzd5l86UwfI9_a";
    mac.secretKey = "V09N6hmt3Z4vieC7Ps3g6HAyQ136cGSmAj7UtjWv";
#endif
...
printf("\n-----------------------------------\n");
	printf("%s\n", downloadUrl("o9mmpvxgk.bkt.clouddn.com", "a.txt", &mac));
printf("\n-----------------------------------\n");
